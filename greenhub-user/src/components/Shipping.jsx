          ...
          {step === 1 ? (
            ...
            <div className="space-y-6 animate-fadeIn">
              ...
              <div className="flex gap-4">
                ...
                <button
                  disabled={loading || !formData.transaction_no}
                  onClick={handleSubmit}
                  className="flex-[2] bg-black text-white font-bold py-4 rounded-2xl hover:bg-gray-800 transition shadow-lg disabled:bg-gray-300"
                >
