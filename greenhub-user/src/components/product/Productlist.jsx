              ...
              <div className="p-4">
                ...
                <div className="flex items-center justify-between mt-auto">
                  ...
                  <div className="relative group">
                    {" "}
                    {/* Add a group wrapper for the tooltip */}
                    <button
                    ...
                    {p.stock_qty <= 0 && (
                      <div className="absolute bottom-full mb-2 left-1/2 -translate-x-1/2 px-2 py-1 bg-gray-800 text-white text-[10px] rounded whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
                        Out of Stock
