...
const Heroimg = ({title,desc}) => {
  return (
    <div className="relative min-h-[300px] flex items-center text-white px-4 sm:px-8 md:px-12 z-0">
      ...
      <div className="relative z-10 mx-auto text-center px-4">
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold leading-tight">
          <span className="bg-gradient-to-r from-lime-500 to-lime-300 text-transparent bg-clip-text">
            {title}
          </span>
