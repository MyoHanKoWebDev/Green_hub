      ...
      <div className="flex min-h-full flex-col justify-center px-6 py-8 lg:px-8">
        ...
        <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-sm ">
          ...
          <form
            ...
            className="space-y-6 p-5 bg-gray-100 rounded-xl"
          >
            <div>
              ...
              <div className="mt-2">
                <input
                  ...
                  type="email"
                  required
                  className={`block w-full rounded-md bg-white px-3 py-1.5 text-gray-900 outline-1 -outline-offset-1 outline-gray-300 focus:outline-2 focus:outline-lime-600 sm:text-sm/6`}
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="mt-2 relative">
                <input
                  ...
                  required
                  className="block w-full rounded-md bg-white px-3 py-1.5 pr-10 text-gray-900 outline-1 -outline-offset-1 outline-gray-300 focus:outline-2 focus:outline-lime-600 sm:text-sm/6"
                />
                {/* Eye Icon Button */}
                <button
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ref={rememberRef}
                  type="checkbox"
                  className="h-4 w-4 text-lime-600 focus:ring-lime-500 border-gray-300 rounded cursor-pointer"
                />
              ...
              <Link
                to="/forgot-password"
                className="text-sm font-semibold text-lime-500 hover:text-lime-600 hover:underline"
              >
                Forgot password?
              </Link>
            </div>
            ...
            <div className="flex items-center justify-between my-4">
              <hr className="w-24 text-gray-300" />
